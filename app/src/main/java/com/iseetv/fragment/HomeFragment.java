...
public class HomeFragment extends Fragment {
    ...
    ArrayList<ItemChannel> mSliderList, mLatestList,mlistindo,mlistkorea;
    ...
    RecyclerView rvLatest, rvCategory,rvindo,rvkorea;
    Button btnMoreLatest, btnMoreCategory,btnmoreindo,btnmorekorea;
    ChannelAdapter channelAdapter,indoAdapter,koreadapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rvkorea=rootView.findViewById(R.id.rv_korea);
...
//        rvCategory = rootView.findViewById(R.id.rv_category);
        ...
        btnmorekorea=rootView.findViewById(R.id.btn_homekorea);
//        btnMoreCategory = rootView.findViewById(R.id.btn_category);
        ...
        rvkorea.setHasFixedSize(true);
        rvkorea.setNestedScrollingEnabled(false);
        rvkorea.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false));

        ItemOffsetDecoration itemDecoration = new ItemOffsetDecoration(requireActivity(), R.dimen.item_offset);
        rvLatest.addItemDecoration(itemDecoration);
        rvindo.addItemDecoration(itemDecoration);
        rvkorea.addItemDecoration(itemDecoration);
        ...
        btnmorekorea.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void displayData() {
        ...
        koreadapter = new ChannelAdapter(getActivity(), mlistkorea, R.layout.row_home_channel_item);
        rvkorea.setAdapter(koreadapter);
//
